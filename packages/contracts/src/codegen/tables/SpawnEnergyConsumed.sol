...
library SpawnEnergyConsumed {
   ...
   * @notice Get energy.
   */
  function getEnergy(address player) internal view returns (uint128 energy) {
   ...
   * @notice Get energy.
   */
  function _getEnergy(address player) internal view returns (uint128 energy) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(player)));
   ...
   * @notice Get energy.
   */
  function get(address player) internal view returns (uint128 energy) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(player)));
   ...
   * @notice Get energy.
   */
  function _get(address player) internal view returns (uint128 energy) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(player)));
   ...
   * @notice Set energy.
   */
  function setEnergy(address player, uint128 energy) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(player)));
   ...
   * @notice Set energy.
   */
  function _setEnergy(address player, uint128 energy) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(player)));
   ...
   * @notice Set energy.
   */
  function set(address player, uint128 energy) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(player)));
   ...
   * @notice Set energy.
   */
  function _set(address player, uint128 energy) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(player)));
