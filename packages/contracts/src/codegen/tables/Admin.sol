...
library Admin {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "eth-monument", name: "Admin", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74626574682d6d6f6e756d656e74000041646d696e0000000000000000000000);
   ...
   * @notice Get admin.
   */
  function get() internal view returns (address admin) {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Get admin.
   */
  function _get() internal view returns (address admin) {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Set admin.
   */
  function set(address admin) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Set admin.
   */
  function _set(address admin) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);
