...
library ForceField {
   ...
   * @notice Get entityId.
   */
  function getEntityId() internal view returns (EntityId entityId) {
   ...
   * @notice Get entityId.
   */
  function _getEntityId() internal view returns (EntityId entityId) {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Get entityId.
   */
  function get() internal view returns (EntityId entityId) {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Get entityId.
   */
  function _get() internal view returns (EntityId entityId) {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Set entityId.
   */
  function setEntityId(EntityId entityId) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Set entityId.
   */
  function _setEntityId(EntityId entityId) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Set entityId.
   */
  function set(EntityId entityId) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Set entityId.
   */
  function _set(EntityId entityId) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);
